...
class ScraperService(
    ...
    private suspend fun runScraperLoop(scraper: WebScraper) {
        while (true) {
                            ...
                            semaphore.withPermit {
                                try {
                                    ...
                                    if (hasTickets) {
                                        ...
                                        if (created.isNotEmpty()) log.info("[${scraper.theatreSlug}] Уведомления созданы: ${perf.title}, кол-во: ${created.size}")
                                    } else {
            ...
            delay(Random.nextLong(10_000L, 25_000L).milliseconds)
        }
    }
}
